...
class Cafe():
    ...
    def __init__(self, root):
       ...
       #-------------------------------------------------Forgot Password Widgets--------------------------------------------
        ...
        print("Number of Daily Meals today: {}".format(NumofMeals))
        global DailyMealsToday
        DailyMealsToday = []
        DisplayMOTD = 0
        for NumofMeals in MealOfTheDay[Date]:
            DailyMealsToday.append(MealOfTheDay[Date][DisplayMOTD])
            DisplayMOTD = DisplayMOTD + 1
            print(NumofMeals)
        
        variable = StringVar(self.MenuPage)
        variable.set(DailyMealsToday[0])
        ...
        self.DailyMeal = OptionMenu(self.MenuPage, variable, *DailyMealsToday)
        ...
        self.LogOutButton = Button(self.MenuPage, text = "Log Out", command = self.Logged_Screen)
        ...
        self.ToOrdersButton = Button(self.LoggedScreen, text = "Orders")
    ...
    def Menu(self):
        ...
        self.CartButton.grid(column = 2, sticky = E, row = 21)
        self.LogOutButton.grid(column = 0, sticky = W, row = 21)
